 ...
 *
 */
public class AVTransportControlPointAdapter implements ControlPointAdapter {

    public ServiceType getServiceType() {
        return new UDAServiceType("AVTransport", 1);
    }

    public void start(Controller controller, UpnpService upnpService, Service service) {
        JFrame view = new AVTransportController(controller, upnpService.getControlPoint(), service).getView();

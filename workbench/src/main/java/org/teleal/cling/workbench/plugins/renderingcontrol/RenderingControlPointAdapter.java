 ...
 *
 */
public class RenderingControlPointAdapter implements ControlPointAdapter {

    public ServiceType getServiceType() {
        return new UDAServiceType("RenderingControl", 1);
    }

    public void start(Controller controller, UpnpService upnpService, Service service) {
        JFrame view = new RenderingController(controller, upnpService.getControlPoint(), service).getView();

 ...
 *
 */
public class NoMediaPresent extends AVTransportClientState {

    public NoMediaPresent(InstanceController instanceController) {
    ...
    public void onEntry() {
        new UserInterfaceUpdate() {
            protected void run(InstanceController controller) {
                controller.getPlayerPanel().setBorder(BorderFactory.createTitledBorder("NO MEDIA PRESENT"));

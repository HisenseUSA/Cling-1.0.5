 ...
 *
 */
public class Transitioning extends AVTransportClientState {

    public Transitioning(InstanceController instanceController) {
    ...
    public void onEntry() {
        new UserInterfaceUpdate() {
            protected void run(InstanceController controller) {
                controller.getPlayerPanel().setBorder(BorderFactory.createTitledBorder("TRANSITIONING"));

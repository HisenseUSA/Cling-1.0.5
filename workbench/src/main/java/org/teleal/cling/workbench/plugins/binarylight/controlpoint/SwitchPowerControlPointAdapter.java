...
public class SwitchPowerControlPointAdapter implements ControlPointAdapter {

    public ServiceType getServiceType() {
        return new UDAServiceType("SwitchPower", 1);
    }

    public void start(Controller controller, UpnpService upnpService, Service service) {
        JFrame view = new SwitchPowerController(controller, upnpService, service).getView();
